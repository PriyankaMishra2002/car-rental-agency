...
?>
    <div class="hai">
        ...
        <div class="content">
            ...
            <h1>Lease The <br><span>Car Of Your Dreams</span></h1>
            <p class="par">Elevate your experiences with us.<br>
            Indulge in luxury with our diverse car rental options.<br> Join us and be part of our growing family, creating lasting memories.  </p>
            <button class="cn"><a href="register.php">Register Here</a></button>
            <div class="form">
                <h2>Login Here</h2>
                <form method="POST"> 
                ...
                <a href="register.php">Register Here</a> here</a></p>
